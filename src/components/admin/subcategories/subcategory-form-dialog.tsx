        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              style={{
                paddingLeft: `${
                  ((selectedParent?.slug || "category").length + 12) * 8
                }px`,
              }}
              className="w-full pr-4 py-2.5 text-xs font-mono rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800/60 text-zinc-900 dark:text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
            />
          </div>
        </div>
