  ...
  return (
    <button
      ...
      className={cn(
        ...
        "border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 hover:bg-zinc-50/80 dark:hover:bg-zinc-900 active:bg-zinc-100 dark:active:bg-zinc-800",
        "text-zinc-700 dark:text-zinc-200 text-sm font-medium transition-all duration-150 shadow-xs cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed",
